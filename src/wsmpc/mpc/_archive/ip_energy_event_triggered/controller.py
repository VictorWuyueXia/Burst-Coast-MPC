"""Closed-loop energy-event triggered MPC controller."""
...
from wsmpc.mpc.ip_energy_event_triggered.problem import solve_candidate_task, split_candidates
...
class EnergyEventMPCController:
    """Compute burst-coast actions from the simplified energy-event objective."""

    identity = "IP-energy-eventTriggered"
